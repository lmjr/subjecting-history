...
<ul id="nav">
	...
	?>
    <li><a href="http://twitter.com/sfstatelca" id="btn_twitter" class="css_btn">@SFStateLCA</a></li>
    <li><a href="http://subjectinghistory.org/feed/" id="btn_rss" class="css_btn">RSS</a></li>
</ul>
